...
const Partners = () => {
  return (
    <section className="relative my-20">
      ...
      <h1 className="text font-bold text-xl lg:text-4xl">Partners and Sponsors</h1>
      <p className="text-xs lg:text-sm">Getlinked Hackathon 1.0 is honored to have the following major companies as its partners and sponsors</p>
      </div>
