  ...
  return (
    <section className="my-20" id="timeline">
      <div className="max-w-[80%] text-white mx-auto flex flex-col items-center justify-center w-full">
        <h1 className="text text-xl font-bold lg:text-4xl">Timeline</h1>
        <p className="text-sm mt-5 text-center max-w-xs lg:max-w-sm">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center justify-center gap-20">
              <div className="flex flex-col text-end w-full">
                <p className="font-bold text-[#D434FE] text-2xl">
            ...
            <div className="flex items-center justify-center gap-20 mt-32">
              ...
              <div className="flex w-full">
                <p className="font-bold text-xs text-[#D434FE] lg:text-2xl">
                  November 18, 2023
                </p>
              </div>
            </div>
...
const MobileTimeline = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center gap-6 lg:hidden">
      <div className="flex items-center justify-start w-full gap-2">
        <div className="flex flex-col items-center justify-center gap-2">
          <div className="w-0.5 h-20 bg-[#D434FE]"></div>
          <p className="gradient flex items-center justify-center rounded-full p-3 w-3 h-3 font-bold text-xs">
            1
          </p>
        </div>
        <div className="flex flex-col justify-between gap-3">
          <p className="font-bold text-[#D434FE] text-xs">
            Hackathon Announcement
          </p>
